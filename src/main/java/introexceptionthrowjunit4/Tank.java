...
Gyakorlati feladat - Lövegcső
        ...
        Ezután írd meg a teszteseteket is a metódus helyes működésének ellenőrzésére a TankTest osztályba! Legyen négy tesztmetódus: egy, ami a helyes működést vizsgálja, valamint három, amelyben kivétel keletkezik! A három utóbbit a lecke szövegében említett háromféle módszer szerint írd meg, mindegyik alapján egyet-egyet!
*/
