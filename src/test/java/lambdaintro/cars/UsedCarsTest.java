...
class UsedCarsTest {
    ...
    void testListCarsByPrice() {
        ...
        assertEquals("Fiat", expected.get(0).brand());
        assertEquals(3_000_000, expected.get(4).price());
    }
    ...
    void testListCarsByLengthDesc() {
        ...
        assertEquals("Ford", expected.get(1).brand());
        assertEquals(4.33, expected.get(3).length());
    }
    ...
    void testListCarsOneBrandByType() {
        ...
        assertEquals("Scudo", expected.get(1).type());
    }
}