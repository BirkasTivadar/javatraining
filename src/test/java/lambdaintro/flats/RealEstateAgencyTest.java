...
class RealEstateAgencyTest {
    ...
    void testFindFirstCheaperFlat() {
        assertEquals(19_000_000, agency.findFirstCheaperFlat(40_000_000).price());
    }
    ...
    void testFindFirstGreaterFlat() {
        assertEquals(46.8, agency.findFirstGreaterFlat(38.2).area());
    }
    ...
    void testFindFirstFlatInSameTown() {
        assertEquals("Győr, Baross utca 4.", agency.findFirstFlatInSameTown("Győr").address());
    }
