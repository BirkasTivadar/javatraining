...
class BankAccountsTest {
    ...
    void testListBankAccountsByAccountNumber() {
        ...
        assertEquals("1", sorted.get(0).accountNumber());
        assertEquals("4", sorted.get(3).accountNumber());
    }
    ...
    void testListBankAccountsByBalance() {
        ...
        assertEquals(90.0, sorted.get(0).balance());
        assertEquals(105.0, sorted.get(3).balance());
    }
    ...
    void testListBankAccountsByBalanceDesc() {
        ...
        assertEquals(105.0, sorted.get(1).balance());
        assertEquals(90.0, sorted.get(3).balance());
        assertEquals(-102.0, sorted.get(4).balance());
    }
    ...
    void testListBankAccountsByNameThanAccountNumber() {
        ...
        assertNull(sorted.get(0).nameOfOwner());
        assertEquals("Ábrahám Doe", sorted.get(1).nameOfOwner());
        assertEquals("Alphonse Doe", sorted.get(2).nameOfOwner());
        assertEquals("John Doe", sorted.get(4).nameOfOwner());
        assertEquals("4", sorted.get(4).accountNumber());
    }
}
