...
class TrooperTest {
    ...
    void testCreate() {
        ...
        assertEquals(0, trooper.getPosition().posX(), 0);
        assertEquals(0, trooper.getPosition().posY(), 0);
    }
    ...
    void testChangePosition() {
        ...
        assertEquals(3, trooper.getPosition().posX(), 0.000001);
        assertEquals(4, trooper.getPosition().posY(), 0.000001);
    }
