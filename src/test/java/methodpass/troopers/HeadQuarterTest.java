...
class HeadQuarterTest {
    ...
    void testMoveTrooperByName() {
        ...
        assertEquals(4, jakeTrooper.getPosition().posX(), 0.000001);
        assertEquals(7, jakeTrooper.getPosition().posY(), 0.000001);

        assertEquals(0, johnTrooper.getPosition().posX(), 0.000001);
        assertEquals(0, johnTrooper.getPosition().posY(), 0.000001);
    }
    ...
    void testMoveClosestTrooper() {
        ...
        assertEquals(10, johnTrooper.getPosition().posX(), 0.000001);
        assertEquals(-4, johnTrooper.getPosition().posY(), 0.000001);

        assertEquals(-2, jakeTrooper.getPosition().posX(), 0.000001);
        assertEquals(5, jakeTrooper.getPosition().posY(), 0.000001);
    }
}