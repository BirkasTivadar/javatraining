...
class VaccineTest {
    ...
    void testFirstVaccine() {
        ...
        Assertions.assertEquals("Nagy Eleonóra", vaccine.getVaccinationList().get(0).name());
        Assertions.assertEquals("Németh Béla", vaccine.getVaccinationList().get(3).name());
        Assertions.assertEquals("Kiss József", vaccine.getVaccinationList().get(6).name());
        Assertions.assertEquals("Kovács Tamás", vaccine.getVaccinationList().get(14).name());
    }
    ...
    void testSecondVaccine() {
        ...
        Assertions.assertEquals("Kiss József", vaccine.getVaccinationList().get(0).name());
        Assertions.assertEquals("Szabó Veronika", vaccine.getVaccinationList().get(1).name());
        Assertions.assertEquals("Németh Béla", vaccine.getVaccinationList().get(5).name());
        Assertions.assertEquals("Török István", vaccine.getVaccinationList().get(6).name());
    }
}