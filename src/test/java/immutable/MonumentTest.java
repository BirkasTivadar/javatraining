...
class MonumentTest {
    ...
    void testCreate() {
        ...
        assertEquals("Plébániatemplom", monument.name());
        assertEquals("5342 Kukutyin, Fő utca 3.", monument.address());
        assertEquals(LocalDate.of(2015, 2, 4), monument.dateOfRegistry());
        assertEquals("MRN-4326-T", monument.registryNumber());
    }
